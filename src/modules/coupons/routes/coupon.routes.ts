...
import { CreateCouponSchema, UpdateCouponSchema, CouponQuerySchema } from "../validators/coupon.schema";
...
export function couponRoutes(): Hono {
  ...
  router.get("/", zValidator("query", CouponQuerySchema), couponController.list);
